<template>
  <div>
    ...
    <p v-if="show">
      Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo ducimus quod
      provident, quae eveniet ipsa voluptatum rem sed sint incidunt ex
      recusandae, debitis reiciendis nostrum, nam minus! Expedita, cupiditate
      nemo.
    </p>
    <hr />
